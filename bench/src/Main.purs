...
-- 8. polyInt — a scalar regression probe with a polymorphic use at loop exit.
--    The optimiser may erase polyBoxed and unbox this without TAST already.
--    Inspect the generated worker before attributing any timing difference to types.
